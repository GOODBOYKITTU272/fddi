...
export default [
  ...
  q('3B02', 'B', 'What is a major concern mentioned regarding AI and creativity?', ['Aesthetic homogenization', 'Increased cost of production', 'Lack of high-speed internet', 'Excessive human intuition'\The passage mentions the risk of designs starting to look similar (homogenization).', { passageRef: 'p1', tag: 'RC Strategy' }),
  ...
  // Grammar
  q('3B16', 'B', 'Error: I have (1) / seen him (2) / ten days ago (3).', ['1', '2', '3', 'No error'\With a specific past time, use simple past: "I saw him".', { tag: 'Para-Jumbles' }),
  ...
  q('3B27', 'B', 'Correct:', ['Occurrence', 'Occurance', 'Occurence', 'Ocurrence'\Double c, double r.', { tag: 'Spelling' }),
  q('3B28', 'B', 'Correct:', ['Manoeuvre', 'Maneuver', 'Manuevre', 'Maneuvre'\Manoeuvre (UK) or Maneuver (US).', { tag: 'Spelling' }),
  q('3B29', 'B', 'Correct:', ['Boutique', 'Butique', 'Bootique', 'Boutiqe'\Boutique.', { tag: 'Spelling' }),
  q('3B30', 'B', 'Correct:', ['Catalogue', 'Cataloge', 'Catalog', 'Both 1 and 3'], 3, 'Catalogue (UK) and Catalog (US) are both correct.', { tag: 'Spelling' }),

  // Fillers
  q('3B31', 'B', 'She is good ___ sketching.', ['at', 'in', 'on', 'with'\Good at something.', { tag: 'RC Strategy' }),
  q('3B32', 'B', 'The price ___ depends on the material.', ['at', 'on', 'of', 'in'], 2, 'Price of.', { tag: 'RC Strategy' }),
  q('3B33', 'B', 'He went ___ the room.', ['into', 'in', 'on', 'at'\Movement into.', { tag: 'RC Strategy' }),
  q('3B34', 'B', 'I have a lot of respect ___ her.', ['for', 'to', 'at', 'on'\Respect for.', { tag: 'RC Strategy' }),
  q('3B35', 'B', 'We are looking forward ___ meeting you.', ['to', 'at', 'for', 'on'\Looking forward to.', { tag: 'RC Strategy' }),

  // One Word
  q('3B36', 'B', 'One who is present everywhere:', ['Omniscient', 'Omnipresent', 'Omnipotent', 'Polyglot'], 1, 'Omnipresent.', { tag: 'One-word Sub' }),
  q('3B37', 'B', 'Handwriting that cannot be read:', ['Illegible', 'Ineligible', 'Corrupt', 'Vague'\Illegible.', { tag: 'One-word Sub' }),
  q('3B38', 'B', 'A person who hates women:', ['Misogynist', 'Misandrist', 'Philanthropist', 'Misanthrope'\Misogynist.', { tag: 'One-word Sub' }),
  q('3B39', 'B', 'The science of time measurement:', ['Horology', 'Chronology', 'Geology', 'Biology'\Horology.', { tag: 'One-word Sub' }),
  q('3B40', 'B', 'Killing of one\'s own brother:', ['Fratricide', 'Patricide', 'Matricide', 'Regicide'\Fratricide.', { tag: 'One-word Sub' }),

  // Para-jumbles
  q('3B41', 'B', 'Arrange: A. Login, B. OTP, C. Register, D. Dashboard.', ['CABD', 'CBAD', 'ACBD', 'BACD'\Register (C) -> Login (A) -> OTP (B) -> Dashboard (D).', { tag: 'Para-Jumbles' }),
  q('3B42', 'B', 'Arrange: A. Sew, B. Cut, C. Measure, D. Wear.', ['CBAD', 'CABD', 'BCAD', 'ADBC'\Measure (C) -> Cut (B) -> Sew (A) -> Wear (D).', { tag: 'Para-Jumbles' }),
  ...
  q('3B44', 'B', 'Arrange: A. Print, B. Layout, C. Type, D. Distribute.', ['CBAD', 'CABD', 'BCAD', 'ACBD'\Type (C) -> Layout (B) -> Print (A) -> Distribute (D).', { tag: 'Para-Jumbles' }),
  q('3B45', 'B', 'Arrange: A. Soil, B. Seed, C. Water, D. Flower.', ['ABCD', 'BACD', 'B CAD', 'BCAD'\Soil (A) -> Seed (B) -> Water (C) -> Flower (D).', { tag: 'Para-Jumbles' }),

  // Sentence Improvement
  q('3B46', 'B', 'Improve: Scarcely had he gone _than_ it started raining.', ['when', 'then', 'that', 'no improvement'\Scarcely/Hardly is followed by "when".', { tag: 'RC Strategy' }),
  q('3B47', 'B', 'Improve: Each of the boys _have_ a book.', ['has', 'having', 'is having', 'no improvement'\"Each" is singular.', { tag: 'RC Strategy' }),
  ...
  q('3B49', 'B', 'Improve: Being a rainy day, I _stay_ at home.', ['stayed', 'stays', 'staying', 'no improvement'\Past tense context.', { tag: 'RC Strategy' }),
