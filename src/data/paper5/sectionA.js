...
export default [
  ...
  q('5A03', 'C', 'Assertion (A): We feel cooler under a fan even though it doesn\'t lower the room temperature.\nReason (R): The air from the fan increases the rate of evaporation of sweat from our skin.', ['Both true; R explains A', 'Both true; R does not explain A', 'A true, R false', 'A false, R true'], 0, 'Correct physical explanation.', { marks: 2, difficulty: 2, tag: 'Assertion-Reason' }),
  ...
  q('5A09', 'D', 'If A is B\'s sister and C is B\'s mother, how is C related to A?', ['Mother', 'Sister', 'Aunt', 'Daughter'], 0, 'C is the mother of both A and B.', { marks: 2, difficulty: 1, tag: 'Blood Relations' }),
  q('5A10', 'E', 'A mirror shows 6:00. Actual time?', ['6:00', '12:00', '3:00', '9:00'], 0, '11:60 - 6:00 = 5:60 = 6:00.', { marks: 2, difficulty: 1, tag: 'Mirror Image' }),
  ...
  q('5A13', 'C', 'Complete the pattern: Z, W, T, Q, ?', ['N', 'O', 'M', 'P'], 0, 'Skip 2 backwards: Z(yx)W(vu)T(sr)Q(po)N.', { marks: 2, difficulty: 2, tag: 'Number Series' }),
  ...
  q('5A16', 'A', 'Find the angle at 9:00.', ['90°', '180°', '0°', '270°'], 0, '90 degrees.', { marks: 2, difficulty: 1, tag: 'Number Series' }),
  ...
  q('5A21', 'A', 'Find the missing term: 1, 4, 27, 16, 125, ?', ['36', '49', '64', '81'], 0, 'n³ for odd, n² for even. 1³, 2², 3³, 4², 5³. Next is 6² = 36.', { marks: 2, difficulty: 3, tag: 'Number Series' }),
  q('5A22', 'B', 'Assertion (A): Diamonds are used for cutting glass.\nReason (R): Diamonds are very hard.', ['Both true; R explains A', 'Both true; R does not explain A', 'A true, R false', 'A false, R true'], 0, 'Correct explanation.', { marks: 2, difficulty: 1, tag: 'Assertion-Reason' }),
