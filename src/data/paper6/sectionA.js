...
export default [
  ...
  q('6A03', 'C', 'Assertion (A): The stars twinkle in the night sky.\nReason (R): The atmosphere of the Earth causes refraction of light.', ['Both true; R explains A', 'Both true; R does not explain A', 'A true, R false', 'A false, R true'], 0, 'Atmospheric refraction causes the apparent position of stars to shift, creating the twinkling effect.', { marks: 2, difficulty: 2, tag: 'Assertion-Reason' }),
  ...
  q('6A05', 'E', 'A man walks 5km West, then turns left and walks 12km. Distance from start?', ['13km', '17km', '7km', '60km'], 0, '√(5² + 12²) = √(25 + 144) = √169 = 13km.', { marks: 2, difficulty: 2, tag: 'Direction Sense' }),
  // ... (Full set to be included)
  q('6A06', 'A', 'If 3+5=16, 4+6=20, then 5+7=?', ['24', '22', '20', '26'], 0, 'Pattern: (a+b)*2. (3+5)*2=16. (4+6)*2=20. (5+7)*2=24.', { marks: 2, difficulty: 2, tag: 'Coding-Decoding' }),
  ...
  q('6A09', 'D', 'If P is the mother of Q and R is the brother of Q, how is R related to P?', ['Son', 'Brother', 'Nephew', 'Father'], 0, 'R is the son of P.', { marks: 2, difficulty: 1, tag: 'Blood Relations' }),
  q('6A10', 'E', 'A clock shows 9:30. Actual time?', ['2:30', '3:30', '9:30', '12:30'], 0, '11:60 - 9:30 = 2:30.', { marks: 2, difficulty: 1, tag: 'Mirror Image' }),
  ...
  q('6A15', 'E', 'If "BLUE" is "RED", "RED" is "GREEN", what is the color of the sky?', ['RED', 'BLUE', 'GREEN', 'SKY'], 0, 'Sky is Blue. Blue is Red.', { marks: 2, difficulty: 1, tag: 'Coding-Decoding' }),
  q('6A16', 'A', 'Find the angle at 3:00.', ['90°', '180°', '0°', '45°'], 0, '90 degrees.', { marks: 2, difficulty: 1, tag: 'Number Series' }),
  ...
  q('6A18', 'C', 'If tomorrow is Sunday, what was yesterday?', ['Friday', 'Saturday', 'Monday', 'Thursday'], 0, 'Tomorrow is Sunday -> Today is Saturday -> Yesterday was Friday.', { marks: 2, difficulty: 1, tag: 'Number Series' }),
  ...
  q('6A22', 'B', 'Assertion (A): We use woollen clothes in winter.\nReason (R): Wool is a bad conductor of heat.', ['Both true; R explains A', 'Both true; R does not explain A', 'A true, R false', 'A false, R true'], 0, 'Correct explanation.', { marks: 2, difficulty: 1, tag: 'Assertion-Reason' }),
  q('6A23', 'C', 'If "D" is "4", "COVER" is "63", then "BASIS" is?', ['50', '55', '60', '65'], 0, 'Sum of positions: 2+1+19+9+19 = 50.', { marks: 2, difficulty: 2, tag: 'Coding-Decoding' }),
  q('6A24', 'D', 'How many squares in a 4x4 grid?', ['16', '30', '25', '20'], 1, '1²+2²+3²+4² = 1+4+9+16 = 30.', { marks: 2, difficulty: 2, tag: 'Number Series' }),
  q('6A25', 'E', 'A train crosses a 100m platform in 10s at 72 km/h. Length of train?', ['100m', '150m', '200m', '50m'], 0, 'Speed = 20 m/s. Dist = 20 * 10 = 200. L + 100 = 200 => L = 100m.', { marks: 2, difficulty: 3, tag: 'Time and Work' })
];
