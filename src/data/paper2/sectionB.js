...
export default [
  ...
  // Vocabulary - Synonyms
  q('2B06', 'B', 'Synonym of _Inundated_:', ['Empty', 'Flooded', 'Ignored', 'Dry'], 1, 'Inundated means overwhelmed or flooded.', { tag: 'Synonyms' }),
  q('2B07', 'B', 'Synonym of _Lethargic_:', ['Energetic', 'Sluggish', 'Alert', 'Happy'], 1, 'Lethargic means lacking energy or sluggish.', { tag: 'Synonyms' }),
  q('2B08', 'B', 'Synonym of _Ominous_:', ['Promising', 'Threatening', 'Joyful', 'Simple'], 1, 'Ominous means giving the impression that something bad is going to happen.', { tag: 'Synonyms' }),
  q('2B09', 'B', 'Synonym of _Pernicious_:', ['Beneficial', 'Harmful', 'Beautiful', 'Quick'], 1, 'Pernicious means having a harmful effect, especially in a gradual way.', { tag: 'Synonyms' }),
  q('2B10', 'B', 'Synonym of _Pragmatic_:', ['Idealistic', 'Practical', 'Angry', 'Confusion'], 1, 'Pragmatic means dealing with things sensibly and realistically.', { tag: 'Synonyms' }),

  // Vocabulary - Antonyms
  q('2B11', 'B', 'Antonym of _Ephemeral_:', ['Brief', 'Eternal', 'Weak', 'Frail'], 1, 'Ephemeral means lasting for a very short time; Eternal is the opposite.', { tag: 'Antonyms' }),
  q('2B12', 'B', 'Antonym of _Benevolent_:', ['Kind', 'Malevolent', 'Generous', 'Polite'], 1, 'Benevolent means well-meaning and kindly; Malevolent means the opposite.', { tag: 'Antonyms' }),
  q('2B13', 'B', 'Antonym of _Obscure_:', ['Hidden', 'Famous', 'Dark', 'Difficult'], 1, 'Obscure means not discovered or known about; Famous means the opposite.', { tag: 'Antonyms' }),
  q('2B14', 'B', 'Antonym of _Resilient_:', ['Strong', 'Fragile', 'Elastic', 'Hard'], 1, 'Resilient means able to withstand or recover quickly from difficulties; Fragile is the opposite.', { tag: 'Antonyms' }),
  q('2B15', 'B', 'Antonym of _Trivial_:', ['Minor', 'Significant', 'Useless', 'Common'], 1, 'Trivial means of little value or importance; Significant is the opposite.', { tag: 'Antonyms' }),

  // Grammar - Error Spotting
  q('2B16', 'B', 'Error: The group (1) / of students (2) / were very disciplined (3).', ['1', '2', '3', 'No error'], 2, 'Collective noun "group" is singular, so it should be "was".', { tag: 'Para-Jumbles' }),
  q('2B17', 'B', 'Error: Neither he (1) / nor I (2) / are going to the meeting (3).', ['1', '2', '3', 'No error'], 2, 'In "neither/nor", the verb agrees with the closer subject ("I"), so it should be "am".', { tag: 'Para-Jumbles' }),
  q('2B18', 'B', 'Error: I would have (1) / helped him (2) / if he asked me (3).', ['1', '2', '3', 'No error'], 2, 'Third conditional: "if he had asked me".', { tag: 'Para-Jumbles' }),
  q('2B19', 'B', 'Error: She acts (1) / as if she (2) / is the boss (3).', ['1', '2', '3', 'No error'], 2, 'Subjunctive mood: "as if she were the boss".', { tag: 'Para-Jumbles' }),
  q('2B20', 'B', 'Error: Between you (1) / and I (2) / this is a secret (3).', ['1', '2', '3', 'No error'], 1, '"Between" is a preposition, so use object pronoun "me".', { tag: 'Para-Jumbles' }),

  // Idioms
  q('2B21', 'B', 'Idiom meaning: _Under the weather_', ['Sunny day', 'Feeling ill', 'In trouble', 'Very happy'], 1, 'Under the weather means feeling slightly unwell.', { tag: 'Idioms' }),
  ...
  q('2B40', 'B', 'Something that cannot be seen through:', ['Transparent', 'Opaque', 'Translucent', 'Clear'], 1, 'Opaque.', { tag: 'One-word Sub' }),
