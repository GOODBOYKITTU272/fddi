...
import { Play, ArrowRight, Brain, BookOpen, Globe, Lightbulb, Clock, BarChart3, Zap, Calendar, Award, ChevronRight } from 'lucide-react';
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {MOCK_SCHEDULE.map((mock) => {
            ...
            const duration = MOCK_DURATION_MIN; // Use central config
            const questions = TOTAL_QUESTIONS; // Use central config
